...
#ifndef PRODUCTRESOURCEFACTORY_H
#define PRODUCTRESOURCEFACTORY_H

#include <QObject>
#include "Server/Resources/ResourceManager/IResourceFactory.h"

class ProductResourceFactory : public IResourceFactory
{
    Q_OBJECT

public:
    explicit ProductResourceFactory(QObject *parent = nullptr);
...
#endif // PRODUCTRESOURCEFACTORY_H
