...
#ifndef USERFLATOBJECTRESOURCEFACTORY_H
#define USERFLATOBJECTRESOURCEFACTORY_H

#include <QObject>
#include "Server/Resources/ResourceManager/IResourceFactory.h"

class UserFlatObjectResourceFactory : public IResourceFactory
{
    Q_OBJECT

public:
    explicit UserFlatObjectResourceFactory(QObject *parent = nullptr);
    virtual ~UserFlatObjectResourceFactory() override;
...
#endif // USERFlatOBJECTRESOURCEFACTORY_H
